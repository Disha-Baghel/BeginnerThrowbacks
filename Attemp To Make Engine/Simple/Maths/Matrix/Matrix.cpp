...
Matrix2D::Matrix2D(const float src[4])
{
	set(src);
}

Matrix2D::Matrix2D(float m0,float m1,float m2,float m3)
{
	set(m0,m1,m2,m3);
}

  void Matrix2D::set(const float src[4])
{
	m[0] = src[0]; m[1] = src[1]; m[2] = src[2]; m[3] = src[3];
}

  void Matrix2D::set(float m0,float m1,float m2,float m3)
{
	m[0] = m0; m[1] = m1; m[2] = m2; m[3] = m3;
}

  void Matrix2D::setRow(int index, const float row[2])
{
	m[index] = row[0]; m[index + 2] = row[1];
}

  void Matrix2D::setRow(int index, const Vector2D& v)
{
	m[index] = v.x; m[index + 2] = v.y;
}

  void Matrix2D::SetColumn(int index, const float col[2])
{
	m[index*2] = col[0]; m[index*2 + 1] = col[1];
}

  void Matrix2D::SetColumn(int index, const Vector2D& v)
{
	m[index*2] = v.x; m[index*2 + 1] = v.y;
}

  const float* Matrix2D::get() const
{
	return m;
}

  const float* Matrix2D::getTranspose()
{
	tm[0] = m[0];	tm[2] = m[1];
	tm[1] = m[2];	tm[3] = m[3];
	return tm;
...
{
	return Vector2D(m[index], m[index+2]);
}

  Vector2D Matrix2D::getColumn(int index) const
{
	return Vector2D(m[index*2], m[index*2+1]);
}
...
{
	return Matrix2D(m[0]+rhs[0], m[1]+rhs[1], m[2]+rhs[2], m[3]+rhs[3]);
}
  ...
  Vector2D Matrix2D::operator*(const Vector2D& rhs) const
{
  ...
  Matrix2D Matrix2D::operator*(const Matrix2D& rhs) const
{
    return Matrix2D(m[0]*rhs[0] + m[2]*rhs[1],  m[1]*rhs[0] + m[3]*rhs[1],
...
{
    return Matrix2D(-rhs[0], -rhs[1], -rhs[2], -rhs[3]);
}



  Matrix2D operator*(float s, const Matrix2D& rhs)
{
    return Matrix2D(s*rhs[0], s*rhs[1], s*rhs[2], s*rhs[3]);
}



  Vector2D operator*(const Vector2D& v, const Matrix2D& rhs)
{
...
Matrix3D::Matrix3D()
{
  ...
  Matrix3D::Matrix3D(const float src[9])
{
    set(src);
}
  ...
  Matrix3D::Matrix3D(float m0, float m1, float m2,
                        ...
                        float m6, float m7, float m8)
{
  ...
  void Matrix3D::set(const float src[9])
{
  ...
  void Matrix3D::set(float m0, float m1, float m2,
                         float m3, float m4, float m5,
                         float m6, float m7, float m8)
{
  ...
  void Matrix3D::setRow(int index, const float row[3])
{
  ...
  void Matrix3D::setRow(int index, const Vector3D& v)
{
  ...
  void Matrix3D::setColumn(int index, const float col[3])
{
  ...
  void Matrix3D::setColumn(int index, const Vector3D& v)
{
  ...
  const float* Matrix3D::get() const
{
    return m;
}
  ...
  const float* Matrix3D::getTranspose()
{
...
{
    return Matrix3D(m[0]+rhs[0], m[1]+rhs[1], m[2]+rhs[2],
  ...
  Vector3D Matrix3D::operator*(const Vector3D& rhs) const
{
  ...
  Matrix3D Matrix3D::operator*(const Matrix3D& rhs) const
{
    return Matrix3D(m[0]*rhs[0] + m[3]*rhs[1] + m[6]*rhs[2],  m[1]*rhs[0] + m[4]*rhs[1] + m[7]*rhs[2],  m[2]*rhs[0] + m[5]*rhs[1] + m[8]*rhs[2],
...
{
    return Matrix3D(-rhs[0], -rhs[1], -rhs[2], -rhs[3], -rhs[4], -rhs[5], -rhs[6], -rhs[7], -rhs[8]);
}



  Matrix3D operator*(float s, const Matrix3D& rhs)
{
    return Matrix3D(s*rhs[0], s*rhs[1], s*rhs[2], s*rhs[3], s*rhs[4], s*rhs[5], s*rhs[6], s*rhs[7], s*rhs[8]);
}
  ...
  Matrix4D::Matrix4D()
{
  ...
  Matrix4D::Matrix4D(const float src[16])
{
    set(src);
}
                        ...
                        float m12, float m13, float m14, float m15)
{
  ...
  void Matrix4D::set(const float src[16])
{
    m[0] = src[0];  m[1] = src[1];  m[2] = src[2];  m[3] = src[3];
                         ...
                         float m12, float m13, float m14, float m15)
{
  ...
  void Matrix4D::setRow(int index, const float row[4])
{
  ...
  void Matrix4D::setRow(int index, const Vector4D& v)
{
  ...
  void Matrix4D::setRow(int index, const Vector3D& v)
{
  ...
  void Matrix4D::setColumn(int index, const float col[4])
{
  ...
  void Matrix4D::setColumn(int index, const Vector4D& v)
{
  ...
  void Matrix4D::setColumn(int index, const Vector3D& v)
{
  ...
  const float* Matrix4D::get() const
{
    return m;
}
  ...
  const float* Matrix4D::getTranspose()
{
...
{
    return Vector4D(m[index], m[index+4], m[index+8], m[index+12]);
}
...
{
    return Vector4D(m[index*4], m[index*4+1], m[index*4+2], m[index*4+3]);
}



  Vector3D Matrix4D::getLeftAxis() const
{
  ...
  Vector3D Matrix4D::getUpAxis() const
{
  ...
  Vector3D Matrix4D::getForwardAxis() const
{
...
{
    return Matrix4D(m[0]+rhs[0],   m[1]+rhs[1],   m[2]+rhs[2],   m[3]+rhs[3],
  ...
  Vector4D Matrix4D::operator*(const Vector4D& rhs) const
{
  ...
  Vector3D Matrix4D::operator*(const Vector3D& rhs) const
{
...
{
    return Matrix4D(m[0]*n[0]  + m[4]*n[1]  + m[8]*n[2]  + m[12]*n[3],   m[1]*n[0]  + m[5]*n[1]  + m[9]*n[2]  + m[13]*n[3],   m[2]*n[0]  + m[6]*n[1]  + m[10]*n[2]  + m[14]*n[3],   m[3]*n[0]  + m[7]*n[1]  + m[11]*n[2]  + m[15]*n[3],
  ...
  Matrix4D& Matrix4D::operator*=(const Matrix4D& rhs)
{
  ...
  bool Matrix4D::operator==(const Matrix4D& n) const
{
...
{
    return Matrix4D(-rhs[0], -rhs[1], -rhs[2], -rhs[3], -rhs[4], -rhs[5], -rhs[6], -rhs[7], -rhs[8], -rhs[9], -rhs[10], -rhs[11], -rhs[12], -rhs[13], -rhs[14], -rhs[15]);
}



  Matrix4D operator*(float s, const Matrix4D& rhs)
{
    return Matrix4D(s*rhs[0], s*rhs[1], s*rhs[2], s*rhs[3], s*rhs[4], s*rhs[5], s*rhs[6], s*rhs[7], s*rhs[8], s*rhs[9], s*rhs[10], s*rhs[11], s*rhs[12], s*rhs[13], s*rhs[14], s*rhs[15]);
}
...
///////////////////////////////////////////////////////////////////////////////
Vector3D Matrix3D::getAngle() const
{
...
///////////////////////////////////////////////////////////////////////////////
Matrix4D& Matrix4D::invertEuclidean()
{
...
{
    // R^-1
    Matrix3D r(m[0],m[1],m[2], m[4],m[5],m[6], m[8],m[9],m[10]);
    r.invert();
...
///////////////////////////////////////////////////////////////////////////////
Matrix4D& Matrix4D::invertProjective()
{
    // partition
    Matrix2D a(m[0], m[1], m[4], m[5]);
    Matrix2D b(m[8], m[9], m[12], m[13]);
    Matrix2D c(m[2], m[3], m[6], m[7]);
    Matrix2D d(m[10], m[11], m[14], m[15]);

    // pre-compute repeated parts
    a.invert();             // A^-1
    Matrix2D ab = a * b;     // A^-1 * B
    Matrix2D ca = c * a;     // C * A^-1
    Matrix2D cab = ca * b;   // C * A^-1 * B
    Matrix2D dcab = d - cab; // D - C * A^-1 * B
    ...
    // compute D' and -D'
    Matrix2D d1 = dcab;      //  (D - C * A^-1 * B)
    d1.invert();            //  (D - C * A^-1 * B)^-1
    Matrix2D d2 = -d1;       // -(D - C * A^-1 * B)^-1

    // compute C'
    Matrix2D c1 = d2 * ca;   // -D' * (C * A^-1)

    // compute B'
    Matrix2D b1 = ab * d2;   // (A^-1 * B) * -D'

    // compute A'
    Matrix2D a1 = a - (ab * c1); // A^-1 - (A^-1 * B) * C'
...
// M^-1 = adj(M) / det(M)
///////////////////////////////////////////////////////////////////////////////
Matrix4D& Matrix4D::invertGeneral()
{
...
///////////////////////////////////////////////////////////////////////////////
float Matrix4D::getCofactor(float m0, float m1, float m2,
                           float m3, float m4, float m5,
...
///////////////////////////////////////////////////////////////////////////////
Matrix4D& Matrix4D::translate(const Vector3D& v)
{
    return translate(v.x, v.y, v.z);
}

Matrix4D& Matrix4D::translate(float x, float y, float z)
{
...
Matrix4D& Matrix4D::rotate(float angle, float x, float y, float z)
{
...
///////////////////////////////////////////////////////////////////////////////
Matrix4D& Matrix4D::lookAt(const Vector3D& target)
{
...
Matrix4D& Matrix4D::lookAt(const Vector3D& target, const Vector3D& upVec)
{
    // compute forward vector and normalize
    Vector3D position = Vector3D(m[12], m[13], m[14]);
    Vector3D forward = target - position;
...
Matrix4D& Matrix4D::lookAt(float tx, float ty, float tz)
{
    return lookAt(Vector3D(tx, ty, tz));
}

Matrix4D& Matrix4D::lookAt(float tx, float ty, float tz, float ux, float uy, float uz)
{
...
///////////////////////////////////////////////////////////////////////////////
Matrix4D& Matrix4D::skew(float angle, const Vector3D& axis)
{
...
///////////////////////////////////////////////////////////////////////////////
Vector3D Matrix4D::getAngle() const
{
    float pitch, yaw, roll;         // 3 angles
